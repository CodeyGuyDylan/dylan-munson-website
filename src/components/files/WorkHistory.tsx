...
const boring = [
   ...
   },
   {
      ...
      responsibilities: `I had a lot of different duties here. Most days I would use the forklift to unload trucks and then organize the inventory, then I would go on my smallwares deliveries to local restaurants around the area. Finally I would get back and ready up any big deliveries coming up the next day for the installers. I had a lot of other small tasks such as making price tags, stocking the floor, taking inventory, etc. Despite being pretty boring of a job, I do think it helped me with my organizational skills.`,
   },
]
...
const relevant = [
   ...
   },
   {
      ...
      responsibilities: `I was a 'jack of all trades' type of worker here, though most people in IT at the college are. There aren't well defined roles, so my duties change often, but I feel as though it gave me exposure to a wide variety of tools and languages so I am thankful for it. I worked with Microsoft Office 365 applications such as Powerapps, SharePoint, and Power Automate. I got exposure in Azure in the areas of Azure Logic Apps and Azure Function apps written in C# and TypeScript. I learned how to manage content in the Cascade CMS as well as write templates using Velocity. Some one off jobs have given me experience using MSSQL, writing PowerShell scripts, writing in Classic ASP, and JavaScript/Node.js. It was a lot to keep up with doing different things every day, but I do think it has been beneficial in teaching me how to work in real applications.`,
   },
   {
