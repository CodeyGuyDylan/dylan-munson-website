...
const websiteProjects = [
   {
      ...
      stack: 'Hosted on Netlify, built with Gatsby, Google Drive integration, Netlify CMS, Netlify Functions as "backend", Netlify Forms and Nodemailer for emails',
